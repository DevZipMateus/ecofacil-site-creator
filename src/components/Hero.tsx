      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-8 animate-fade-in">
            ...
            <span className="text-white text-sm font-medium">Buscando soluções eficaz</span>
          </div>
          ...
          {/* H2 - Description (SEO) */}
          <h2 className="text-xl md:text-2xl lg:text-3xl text-white/90 mb-8 leading-relaxed animate-fade-in" style={{ animationDelay: "0.2s" }}>
            Produtos de limpeza, embalagens e consultoria ambiental com qualidade e sustentabilidade
          </h2>

          <p className="text-lg text-white/80 mb-12 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
